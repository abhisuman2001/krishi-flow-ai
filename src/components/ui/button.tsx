  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-white/20 bg-transparent text-foreground hover:bg-white/10 active:scale-95',
        secondary:
          'bg-slate-700 text-white hover:bg-slate-600 active:scale-95',
        ghost:
          'hover:bg-white/10 text-foreground active:scale-95',
        link: 'text-green-500 underline-offset-4 hover:underline',
        gradient:
          'bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 shadow-lg shadow-green-600/30 active:scale-95',
      },
      size: {
